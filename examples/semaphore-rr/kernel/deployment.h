...
#define POK_CONFIG_SCHEDULING_SLOTS {100000000, 100000000, 100000000, 10000000}
#define POK_CONFIG_SCHEDULING_MAJOR_FRAME 2500000000
...
#define POK_CONFIG_PARTITIONS_NTHREADS  {4, 3}
#define POK_CONFIG_PARTITIONS_NLOCKOBJECTS  {1,0}

#define POK_CONFIG_PARTITIONS_SCHEDULER {POK_SCHED_MLFQ, POK_SCHED_MLFQ}
